 <body>
 <!-- ==========Banner-Section========== -->
  <section class="details-banner bg_img" data-background="<?php echo base_url() ?>demoproject/images/<?php echo $data->movie_poster?>" >
        <div class="container">
            <div class="details-banner-wrapper">
            
                <div class="details-banner-thumb">
                    <img src="<?php echo base_url() ?>demoproject/images/<?php echo $data->movie_images?>" alt="movie">
                ...
                <div class="details-banner-content offset-lg-3">
                    ...
                    foreach($cate as $cat)
                    {
                        ...
                        $category[]=$this->db->get('moviecategory')->result();
                    }     
                    ...
                    foreach($cate as $cat)
                    {
                       ...
                       <a href="<?php echo site_url() ?>/industry_controller/display/<?php echo $category[$i][0]->category_name; ?>" class="button">
                            <?php echo $category[$i][0]->category_name;?>
                        </a>
                       <?php $i++;
                    }
                    ?></a>
                    <div class="social-and-duration">
                        <div class="duration-area">
                            ...
                            <div class="item">
                                <i class="far fa-clock"></i><span><a href="<?php echo site_url() ?>/industry_controller/display/<?php echo $data->movie_id ?>"></a><?php echo $data->movie_duration ?></span>
                            </div>
                        </div>
    ...
    <section class="book-section bg-one">
        <div class="container">
            <div class="book-wrapper offset-lg-3">
                ...
                <a href="<?php echo site_url() ?>/ticketcontroller/movie_details/<?php echo $data->movie_id ?>" class="custom-button">book tickets</a>
            </div>
        </div>
    </section>
    <!-- ==========Book-Section========== -->
