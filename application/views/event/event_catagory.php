 ...
 <section class="banner-section">
        <div class="banner-bg bg_img" data-background="<?php  echo base_url() ?>assets/images/banner/banner05.jpg"></div>
        <div class="container">
                            ...
                            foreach($data as $row)
                            {
                                ...
                                <div class="event-grid">
                                    ...
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a href="<?php echo site_url() ?>/event_controller/event_details/<?php echo $row->event_id ?>"><?php echo $row->event_title ?></a>
                                        </h5>
