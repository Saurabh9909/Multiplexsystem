 ...
 <section class="banner-section">
        <div class="banner-bg bg_img" data-background="<?php  echo base_url() ?>assets/images/banner/banner05.jpg">
        <video src="<?php echo base_url() ?>assets/images/banner/videoplayback4.MP4" height="900px" loop preload muted autoplay></video>
</div>
        <div class="container">
                            ...
                            foreach($eventcatagory as $row)
                            {
                                ...
                                <div class="event-grid">
                                    <div class="movie-thumb c-thumb">
                                        <a href="<?php echo site_url() ?>/event_controller/event_details/<?php echo $row->event_id ?>">
                                            <img src="<?php  echo base_url() ?>/demoproject/images/<?php echo $row->event_images ?>" alt="event">
                                        </a>
                                        <div class="event-date">
                                            <h6 class="date-title"><a href="<?php echo site_url() ?>/event_controller/event_details/<?php  echo $row->event_id?>"><?php echo $row->event_date ?></a></h6>
                                            <!-- <span>Dec</span> -->
                                        </div>
                                    </div>
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a style="color:#fff;" href="<?php echo site_url() ?>/event_controller/event_details/<?php echo $row->event_id ?>"><?php echo substr($row->event_title,0,15) ?>...</a>
                                        </h5>
