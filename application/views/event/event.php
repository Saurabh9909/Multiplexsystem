 ...
 <section class="banner-section">
        <div class="banner-bg bg_img" data-background="<?php  echo base_url() ?>assets/images/banner/videoplayback4.MP4">
        </div>
        <div class="container">
                        ...
                        <div class="row mb-10 justify-content-center">
                            ...
                            foreach($data as $row)
                            {
                                ...
                                <div class="event-grid">
                                    <div class="movie-thumb c-thumb"style="height:350px;">
                                        <a href="<?php echo site_url() ?>/event_controller/event_details/<?php echo $row->eventspeaker_id ?>">
                                            <img src="<?php  echo base_url() ?>/demoproject/images/<?php echo $row->event_images ?>" alt="event">
                                        </a>
                                        <div class="event-date">
                                            <h6 class="date-title"><a href="<?php echo site_url() ?>/event_controller/event/<?php  echo $row->event_id?>"><?php echo $row->event_date ?></a></h6>
                                            <!-- <span>Dec</span> -->
                                        </div>
                                    </div>
                                    <div class="movie-content bg-one">
                                        <h5 class="title m-0">
                                            <a href="<?php echo site_url() ?>/event_controller/event/<?php echo $event_data->eventspeaker_id ?>"><?php echo $row->event_title ?></a>
                                        </h5>
