...
<div class="col-lg-8" id="foodbevarage" style="margin-left:12rem; width:45rem" >
    ...
    <form action="<?php site_url()?>/matchbookingcontroller/book/<?php echo $match->match_id?>" method="post"></form>
        <div class="checkout-widget checkout-contact">
            <h5 class="title">Your Match Ticket </h5>
            ...
            <!-- <div class="form-group"> -->
                <ul>
                    <li>
                        <h6 class="subtitle"><span>Your Number : </span> <span><?php echo $book['number'] ?></span></h6>
                    </li>
                </ul>
                <input type="hidden" value="<?php echo $book['number']?>" id="user_mobile">
            <!-- </div> -->
            <!-- </div>
        </div>
        <div class="col-lg-4"> -->
                <ul>
                    <li>
                        <h6 class="subtitle"><span>Match :</span>
                        <span>
                        <?php
                ...
                <ul>
                    <li>
                        ...
                        <span id="tctno" value="<?php echo $book['ticketno']; ?>"><?php echo $book['ticketno']; ?></span></h6>
                    </li>
                </ul>
                <ul>
                    <li>
                        <h6 class="subtitle"><span>Match Day</span><span id="ticketctqty" value=""><?php echo $book['ticketqty']; ?></span></h6>
                        <div class="info"><span><?php echo $match->match_date." , ".$match->time?></span> <span>Tickets</span></div>
                    </li>
                </ul>
                <ul>
                    <li>
                        <h6 class="subtitle mb-0"><span>Tickets  Price</span><span id="tctpr" value="">₹ <?php echo $book['ticketprice']; ?></span></h6>
                    </li>
                </ul>
            </div>
        
            <div class="proceed-area  text-center">
                <h6 class="subtitle"><span>Amount Payable</span><span id="total">₹ <?php echo $book['total']; ?></span></h6>             
