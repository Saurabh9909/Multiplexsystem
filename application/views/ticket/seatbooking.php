 <!-- ==========Banner-Section========== -->
 <section class="details-banner hero-area bg_img seat-plan-banner" data-background="<?php echo base_url()?>assets/images/banner/banner04.jpg">
        <div class="container">
                            ...
                            <ul class="seat--area">
                                <li class="front-seat">
                                    <ul>
                                        <li class="single-seat">
                                            <img src="<?php echo base_url()?>assets/images/movie/seat01-free.png" alt="seat">
                                ...
                                <li class="front-seat">
                                    <ul>
                                        ...
                                        <li class="single-seat seat-free">
                                            <img src="<?php echo base_url()?>assets/images/movie/seat01-free.png" alt="seat">
                                            <span class="sit-num">g15</span>
                                        </li>
                                        <li class="single-seat">
                                            <img src="<?php echo base_url()?>assets/images/movie/seat01-free.png" alt="seat">
                                            <span class="sit-num">g16</span>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <ul class="seat--area">
                                ...
                                <li class="front-seat">
                                    <ul>
                                        ...
                                        <li class="single-seat seat-free">
                                            <img src="<?php echo base_url()?>assets/images/movie/seat01-free.png" alt="seat">
                                            <span class="sit-num">f15</span>
                                        </li>
                                        <li class="single-seat">
                                            <img src="<?php echo base_url()?>assets/images/movie/seat01-free.png" alt="seat">
                                            <span class="sit-num">f16</span>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="seat-line">
                            ...
                            <ul class="seat--area">
                                <li class="front-seat">
                                    <ul>
                                        <li class="single-seat">
                                            <img src="<?php echo base_url()?>assets/images/movie/seat02-free.png" alt="seat">
                                        </li>
                                        <li class="single-seat">
                                            <img src="<?php echo base_url()?>assets/images/movie/seat02-free.png" alt="seat">
                                        </li>
                            ...
                            <ul class="seat--area">
                                ...
                                <li class="front-seat">
                                    <ul>
                                        ...
                                        <li class="single-seat seat-free-two">
                                            <img src="<?php echo base_url()?>assets/images/movie/seat02-booked.png" alt="seat">
