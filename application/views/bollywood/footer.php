    ...
    <footer class="footer-section">
        <div class="newslater-section padding-bottom">
            <div class="container">
                <div class="newslater-container bg_img" data-background="<?php echo base_url() ?>assets/images/newslater/newslater-bg01.jpg">
        ...
        <div class="container">
            <div class="footer-top">
                <div class="logo">
                    <a href="index-1.html">
                        <img src="<?php echo base_url() ?>assets/images/footer/logo_3.png"  height="100"alt="footer">
                    </a>
                </div>
            ...
            <div class="footer-bottom">
                <div class="footer-bottom-area">
                    <div class="left">
                        <p>Copyright © 2024.All Rights Reserved By <a href="#0">Booklit </a></p>
                    </div>
                    <ul class="links">       
                        <li>
...
<!-- Mirrored from pixner.net/boleto/demo/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Dec 2021 14:08:59 GMT -->
</html>