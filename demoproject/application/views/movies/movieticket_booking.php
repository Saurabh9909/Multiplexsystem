								...
								<table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
									...
									<tbody>
										...
										<tr>
											...
											<?php
											if($row->ticketbooking_status=="blocked")
											{
											?>
											<td><a class=" btn btn-raised btn-danger btn-sm" href="<?php echo site_url()?>/movieticketbooking_controller/status/<?php echo $row->ticketbooking_id ?>"><?php echo $row->ticketbooking_status ?></a>
											</td>
												<?php
											}
											else
											{
												?>
												<td><a class="btn btn-raised btn-success btn-sm" href="<?php echo site_url()?>/movieticketbooking_controller/status/<?php echo $row->ticketbooking_id ?>"><?php echo $row->ticketbooking_status ?></a>
											</td>
												<?php
											}
											...
											<td><a href="<?php echo site_url()?>/movieticketbooking_controller/edit/<?php echo $row->ticketbooking_id ?>"><i class="fa fa-edit"></i> </a></td>
                                           <td><a href="<?php echo site_url()?>/movieticketbooking_controller/delete/<?php echo $row->ticketbooking_id ?>"><i class="fa fa-trash-o"></i></a></td>
