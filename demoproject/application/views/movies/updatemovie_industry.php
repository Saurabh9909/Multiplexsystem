				...
				<div class="bg-light lter b-b wrapper-md mb-10">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<h1 class="h3 m-0">Movies Industry</h1>
	...
	<div class="row text-center" >
					<div class="col-md-6 col-sm-3">
						<section class="boxs">
							...
							<div class="boxs-body" >
								<form class="form-horizontal" name="form4" role="form" id="form4"  data-parsley-validate  method="post" action="<?php echo site_url()?>/movieindustry_controller/update/<?php echo $edit->industry_id ?>">
									
									
									
									<div class="form-group">
										<label class="col-sm-3 control-label">Movie Industry</label>
										<div class="col-sm-9">
										<input type="text" name="name" class="form-control" value="<?php echo $edit->industry_name?>" placeholder="Enter Movie Industry" data-parsley-trigger="change" required>
