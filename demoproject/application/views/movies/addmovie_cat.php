	...
	<div class="row text-center" >
					<div class="col-md-6 col-sm-3">
						<section class="boxs">
							...
							<div class="boxs-body" >
								<form class="form-horizontal" name="form4" role="form" id="form4"  data-parsley-validate  method="post" action="<?php echo site_url()?>/moviecat_controller/insert">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<input type="text" name="catname" class="form-control" placeholder="Enter Movie Category Name" data-parsley-trigger="change" required>
