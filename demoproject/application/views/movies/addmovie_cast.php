	...
	<div class="row text-center" >
					<div class="col-md-6 col-sm-3">
						<section class="boxs">
							...
							<div class="boxs-body" >
								<form class="form-horizontal" name="form4" role="form" id="form4" enctype="multipart/form-data" data-parsley-validate  method="post" action="<?php echo site_url()?>/moviecast_controller/insert">
									...
									<div class="form-group">
										...
										<input type="text" name="castname" class="form-control" placeholder="Enter Movie Cast Name" data-parsley-trigger="change" required>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                        <input type="text" name="position" class="form-control" placeholder="Enter Cast Position " data-parsley-trigger="change" required>
