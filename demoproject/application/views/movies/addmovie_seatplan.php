				...
				<div class="bg-light lter b-b wrapper-md mb-10">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<h1 class="h3 m-0">Movies Seat Plan</h1>
	...
	<div class="row text-center" >
					<div class="col-md-6 col-sm-3">
						<section class="boxs">
							...
							<div class="boxs-body" >
								<form class="form-horizontal" name="form4" role="form" id="form4"  data-parsley-validate  method="post" action="<?php echo site_url()?>/movieseatplan_controller/insert">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                        <input type="text" name="seat" class="form-control" placeholder="Enter Seat Name" data-parsley-trigger="change" required>
                                    ...
                                    <div class="form-group">
										<label class="col-sm-3 control-label">Seatplan Price	</label>
										<div class="col-sm-9">
                                        <input type="text" name="seatprice" class="form-control" placeholder="Enter Seatplan Price	 " data-parsley-trigger="change" required>
