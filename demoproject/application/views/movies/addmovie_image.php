	...
	<div class="row text-center" >
					<div class="col-md-6 col-sm-3">
						<section class="boxs">
							...
							<div class="boxs-body" >
								<form class="form-horizontal" name="form4" role="form" id="form4" enctype="multipart/form-data" data-parsley-validate  method="post" action="<?php echo site_url()?>/movieimg_controller/insert">
