				...
				<div class="bg-light lter b-b wrapper-md mb-10">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<h1 class="h3 m-0">Movies Images</h1>
	...
	<div class="row text-center" >
					<div class="col-md-6 col-sm-3">
						<section class="boxs">
							...
							<div class="boxs-body" >
								<form class="form-horizontal" name="form4" role="form" id="form4" enctype="multipart/form-data" data-parsley-validate  method="post" action="<?php echo site_url()?>/movieimg_controller/update/<?php echo $edit->movieimg_id?>">
									<div class="form-group">
										...
										<select name="name" class="form-control">
                                            ...
                                            <?php
                                                ...
                                                {
                                                    if($movie->movie_id==$edit->movie_id)
                                                    {
                                            ?>
                                                <option selected value="<?php echo $rowimg->movie_id ?>"><?php echo $rowimg->movie_name ?></option>
                                            <?php
                                                }
                                                else
                                                {
                                            ?>
                                                <option value="<?php echo $rowimg->movie_id ?>"><?php echo $rowimg->movie_name ?></option>
                                            <?php
                                                }
                                            }
                                            ?>
