	...
	<div class="row text-center" >
					<div class="col-md-6 col-sm-3">
						<section class="boxs">
							...
							<div class="boxs-body" >
								<form class="form-horizontal" name="form4" role="form" id="form4"  data-parsley-validate  method="post" action="<?php echo site_url()?>/movieticketplan_controller/insert">
                                ...
                                <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
                                        <input type="text" name="time" class="form-control" placeholder="Enter Movieticket Time" data-parsley-trigger="change" required>
                                    ...
                                    <div class="form-group">
										<label class="col-sm-3 control-label">	Movieticket Date	</label>
										<div class="col-sm-9">
                                        <input type="text" name="date" class="form-control" placeholder="Enter Movieticket Date	 " data-parsley-trigger="change" required>
