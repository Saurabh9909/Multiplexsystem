				...
				<div class="row">
					<div class="col-md-12">
						<section class="boxs">
							...
							<div class="boxs-body">
								<form class="form-horizontal"   name="form4" role="form" id="form4" method="POST" action="<?php echo site_url() ?>/eventcontroller/insert_event"  enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<select name="event_speaker_id" class="form-control">
												...
												<?php  
													foreach($eventspeaker as $eventspeakerrow)
													{
														?>
															<option value="<?php echo $eventspeakerrow->eventspeaker_id ?>"><?php echo $eventspeakerrow->eventspeaker_name ?></option>
														<?php
													}
												?>
											</select>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="event_title" type="text" class="form-control" placeholder="Event Title"   required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="event_trailer" type="text" class="form-control" placeholder="Event Trailer required">
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="event_price" type="text" class="form-control" placeholder="Event Price"  required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="event_description" type="text" class="form-control" placeholder="Event Description"required>
										</div>
									</div>
                                    <hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="event_type" type="text" class="form-control" placeholder="Event Type" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="event_address" type="text" class="form-control" placeholder="Event Address" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="event_date" type="text" class="form-control" placeholder="Event Date" required>
										</div>
									</div>
                                    <hr class="line-dashed full-witdh-line" />
                                    <div class="form-group">
