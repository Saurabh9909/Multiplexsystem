				...
				<div class="row">
					<div class="col-md-12">
						<section class="boxs">
							...
							<div class="boxs-body">
								<form class="form-horizontal" method="post" action="<?php echo site_url() ?>/eventcat_controller/insert_eventcategory"  name="form4" role="form" id="form4" data-parsley-validate>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										<label class="col-sm-3 control-label">Eventcategory Title</label>
										<div class="col-sm-9">
											<input name="eventcategory_title" type="text" class="form-control" placeholder="Eventcategory Title"  required>
										</div>
									</div>
