				...
				<div class="row">
					<div class="col-md-12">
						<section class="boxs">
							...
							<div class="boxs-body">
								<form class="form-horizontal"  enctype="multipart/form-data" method="post" action="<?php echo site_url() ?>/eventspeaker_controller/update_es/<?php echo $edit->eventspeaker_id ?>"  name="form4" role="form" id="form4" data-parsley-validate>
										...
										<div class="col-sm-9">
											<select name="eventcat_id" class="form-control" >
                                                ...
                                                <?php  
													...
													{
                                                        if($eventcatrow->eventcategory_id==$edit->eventcategory_id)
                                                        {
														?>
															<option selected value="<?php echo $eventcatrow->eventcategory_id ?>"><?php echo $eventcatrow->eventcategory_title ?></option>
														<?php
													}
                                                    else
                                                    {
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="eventspeaker_name" type="text" class="form-control" placeholder="EventSpeaker Name" value="<?php echo $edit->eventspeaker_name ?>"  required>
										</div>
									</div>
                                    <hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="eventspeaker_proffession" type="text" class="form-control" placeholder="EventSpeaker Proffesion"   value="<?php echo $edit->eventspeaker_proffession ?>"  required>
										</div>
									</div>
                                    <hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<span class="btn btn-raised btn-success fileinput-button">
												...
												<span>Add files...</span>
												<input name="eventspeaker_profileimg" type="file" class="form-control"  >
											</span>
										</div>
									</div>
