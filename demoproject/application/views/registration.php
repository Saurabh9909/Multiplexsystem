              ...
              <form class="form">
                ...
                <div class="content">
                  <div class="form-group">
                    <input type="text" class="form-control underline-input" placeholder="Enter Your Name" name='name'>
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control underline-input" placeholder="Enter Your Email" name='email'>
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control underline-input" placeholder="Enter Your Mobile" name='mobile'>
                  </div>
                  <div class="form-group">
                ...
                <div class="footer text-center">
                  <a href="<?php echo site_url() ?>/logincontroller" class="btn btn-info btn-raised">Register</a>
                </div>
