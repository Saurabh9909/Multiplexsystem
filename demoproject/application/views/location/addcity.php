				...
				<div class="row">
					<div class="col-md-12">
						<section class="boxs">
							...
							<div class="boxs-body">
								<form class="form-horizontal" method="POST"  action="<?php echo site_url() ?>/city_controller/addcity" name="form4" role="form" id="form4" data-parsley-validate>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="txtcity" class="form-control" placeholder="City" data-parsley-trigger="change" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									</div>
