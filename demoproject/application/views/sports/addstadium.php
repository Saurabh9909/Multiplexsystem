				...
				<div class="row">
					<div class="col-md-12">
						<section class="boxs">
							...
							<div class="boxs-body">
								<form class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?php echo site_url() ?>/sports_controller/insert_stadium"  name="form4" role="form" id="form4" data-parsley-validate>
									
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										<label class="col-sm-3 control-label">Stadium Name</label>
										<div class="col-sm-9">
											<input name="stadium_name" type="text" class="form-control" placeholder="Stadium Name"   required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
