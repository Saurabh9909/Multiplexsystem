				...
				<div class="row">
					<div class="col-md-12">
						<section class="boxs">
							...
							<div class="boxs-body">
								<form class="form-horizontal" enctype="multipart/form-data" method="POST" action="<?php echo site_url() ?>/sports_controller/addsports"  name="form4" role="form" id="form4" data-parsley-validate>
									
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										<label class="col-sm-3 control-label">Sports Title</label>
										<div class="col-sm-9">
											<input name="sports_title" type="text" class="form-control" placeholder="Sports Title"   required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="sports_category" type="text" class="form-control" placeholder="Sports Category" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="sports_details" type="text" class="form-control" placeholder="Sports Details"  required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="sportsticket_price" type="img" class="form-control" placeholder="Sportsticket Price"  required>
										</div>
									</div>
                                    <hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<span class="btn btn-raised btn-success fileinput-button">
												...
												<span>Add Files....</span>
												<input name="sports_images" type="file" class="form-control" placeholder="Sports Images" required>
											</span>
										</div>
									</div>
                                    <hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="sports_date" type="text" class="form-control" placeholder="Sports Date" required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
