				...
				<div class="row">
					<div class="col-md-12">
						<section class="boxs">
							...
							<div class="boxs-body">
								<form class="form-horizontal" method="POST" action="<?php echo site_url() ?>/multiplex_controller/addmultiplex"  name="form4" role="form" id="form4" data-parsley-validate>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="multiplex_name" type="text" class="form-control" placeholder="Multiplex Name"   required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="no_of_screen" type="number" class="form-control" placeholder="No of Screen" required>
										</div>
									</div>
							</div>
