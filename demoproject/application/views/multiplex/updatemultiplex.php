						...
						<section class="boxs">
							<div class="boxs-header">
								<h3 class="custom-font hb-blush">
									<strong>Update Multiplex</strong></h3>
							</div>
							<div class="boxs-body">
								<form class="form-horizontal" method="POST" action="<?php echo site_url() ?>/multiplex_controller/update_multiplex/<?php echo $edit->multiplex_id ?>"  name="form4" role="form" id="form4" data-parsley-validate>
									<div class="form-group">
										<label class="col-sm-3 control-label">State</label>
										<div class="col-sm-9">
											<select name="state_id" id="state" onchange="getcity(this.value)" value="<?php echo $edit->state_id ?>" class="form-control">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<select name="city_id" id="city" onchange="getarea	(this.value)" value="<?php echo $edit->city_id ?>" class="form-control">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<select name="area_id" id="area"class="form-control" value="<?php echo $edit->area_id ?>" >
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="multiplex_name" type="text" class="form-control" placeholder="Multiplex Name" value="<?php echo $edit->multiplex_name ?>"  required>
										</div>
									</div>
									<hr class="line-dashed full-witdh-line" />
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="no_of_screen" type="number" class="form-control" placeholder="No of Screen" value="<?php echo $edit->no_of_screen ?> "required>
										</div>
									</div>
							</div>
