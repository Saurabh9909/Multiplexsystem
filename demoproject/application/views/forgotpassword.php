        ...
        <div class="row">
          <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
            <div class="card card-signup">
              <form class="form" method="post" action="<?php echo site_url() ?>/logincontroller/change_pass">
                ...
                <!-- <div class="form-group">
                    <input type="hidden" name="txtemail" value="<?php echo $row->admin_email ?>" placeholder="New Password..." class="form-control underline-input">
                  </div> -->
                  <div class="form-group">
                    <input type="password" name="txtpassword" placeholder="New Password..." class="form-control underline-input">
                  </div>
                  <div class="form-group">
                    <input type="password" name="txtcpassword" placeholder="Confirm Password..." class="form-control underline-input">
                  </div>
